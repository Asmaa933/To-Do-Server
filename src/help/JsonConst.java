...
public class JsonConst {
    ...
    public static final String TYPE_EMAIL_SIGNIN_REQUEST = "email_signin_request";
    public static final String EMAIL = "email";
    public static final String TYPE_PASSWORD_SIGNIN_REQUEST = "password_signin_request";
